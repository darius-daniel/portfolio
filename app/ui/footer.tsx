...
export default function Footer() {
  return (
    <footer className="flex flex-row w-full text-secondary-1 divide-x divide-ash sm:max-lg:divide-x-0 border-t border-ash text-[16px] font-medium fixed md:relative bottom-0">
      <span className="max-lg:w-1/2 p-4 min-w-fit">Find me on:</span>
